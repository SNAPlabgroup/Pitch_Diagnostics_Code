...
plot(mean(TTS_Pre_f2,1, 'omitNaN'),mean(TTS_Pre_oae,1, 'omitNaN'),'Color',blck,'linewidth',1.5);
...
hold on;
plot(mean(TTS_Post_1d_f2,1, 'omitNaN'),mean(TTS_Post_1d_oae,1, 'omitNaN'),':', 'Color',rd,'linewidth',1.5);
...
plot(mean(PTS_Pre_f2,1, 'omitNaN'),mean(PTS_Pre_oae,1, 'omitNaN'),'Color',blck,'linewidth',1.5);
plot(mean(PTS_Pre_f2,1, 'omitNaN'),mean(PTS_Pre_nf,1, 'omitNaN'),'--', 'Color',blck,'linewidth',1.5);
plot(mean(PTS_Pre_centerfreq,1, 'omitNaN'),mean(PTS_Pre_oaesum,1, 'omitNaN'),'*','Color',blck,'MarkerSize',10,'LineWidth',2);

hold on;
plot(mean(PTS_Post_f2,1, 'omitNaN'),mean(PTS_Post_oae,1, 'omitNaN'),'Color',yel,'linewidth',1.5);
plot(mean(PTS_Post_f2,1, 'omitNaN'),mean(PTS_Post_nf,1, 'omitNaN'),'--', 'Color',yel,'linewidth',1.5);
...
plot(mean(GE_Pre_f2,1, 'omitNaN'),mean(GE_Pre_oae,1, 'omitNaN'),'Color',blck,'linewidth',1.5);
