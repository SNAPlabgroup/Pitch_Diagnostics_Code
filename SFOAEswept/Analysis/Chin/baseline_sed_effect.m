...
clear;
% 
chins = {'Q453'}; % 'Q431', 'Q424', 'Q428', 'Q422', 'Q441', 'Q440'}; %Q442
%chins = {'Q431', 'Q424', 'Q426', 'Q428', 'Q421', 'Q441'};
...
title('Swept SFOAEs','FontSize',16);

for i = 1:size(a_Pre_f2,1)
    plot(a_Pre_f2(i,:),a_Pre_oae(i,:), 'Color',pre_sed_ind,'linewidth',2, 'HandleVisibility','off');
    plot(a_Pre_f2(i,:),a_Pre_nf(i,:), '--', 'Color',pre_sed_ind,'linewidth',2, 'HandleVisibility','off');
    plot(a_Pre_centerfreq(i,:),a_Pre_oaesum(i,:),'o','Color',pre_sed_group,'MarkerSize',10, 'HandleVisibility','off');
end


for i = 1:size(s_Pre_f2,1)
    plot(s_Pre_f2(i,:),s_Pre_oae(i,:),'Color',post_sed_ind,'linewidth',2, 'HandleVisibility','off');
        plot(s_Pre_f2(i,:),s_Pre_nf(i,:),'--', 'Color',post_sed_ind,'linewidth',2, 'HandleVisibility','off');
    plot(s_Pre_centerfreq(i,:),s_Pre_oaesum(i,:),'x','Color',post_sed_ind,'MarkerSize',10,'LineWidth',2, 'HandleVisibility','off');
end
